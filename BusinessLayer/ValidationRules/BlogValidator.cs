...
namespace BusinessLayer.ValidationRules
{
    public class BlogValidator : AbstractValidator<Blog>
    {
        public BlogValidator()
        {
            ...
            RuleFor(x => x.Description2).MaximumLength(1000).WithMessage("Açıklama en fazla 1000 karakterden oluşturulmalıdır");
            RuleFor(x => x.Description2).MinimumLength(200).WithMessage("Açıklama en az 200 karakterden oluşturulmalıdır");
        }
    }
}
